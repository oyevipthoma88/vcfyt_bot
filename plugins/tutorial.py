...
SECTIONS = {
    ...
    "effects": (
        ...
        "🎙️ Voice ke liye: bass moderate, treble 55–75, gain 100–150.\n"
    ...
    "library": (
        ...
        "bhejega. Us audio message ko reply karke <code>.tag myaudio</code> likhein.\n"
        "Phir group ke VC mein <code>.play myaudio &lt;chat_id&gt;</code> likhein.\n"
        "Example: <code>.play myaudio -1001234567890</code>.\n"
    ...
    "faq": (
        ...
        "boosted hai; echo off rakhein. Zarurat par `/gain 150` + `/treble 75` try karein.\n\n"
